    ...
    public boolean onPreferenceChange(Preference preference, Object value) {
        ...
        if ( !mBindingPreference ) {
            if (preference.getKey().equals(getString(R.string.pref_location_key))) {
                ADomicilioSyncAdapter.syncImmediately(this);
                //FetchInfoTask weatherTask = new FetchInfoTask(this);
                //String location = value.toString();
                //ASK only of the country chosen
            } else {
                // notify code that weather may be impacted
                //Notify Change of restaurants depending on country.
                getContentResolver().notifyChange(ADomicilioContract.PlaceEntry.CONTENT_URI, null);
            }
        }
